...
staleness_signal: "Stale when the C1-style checks in finalizer.rs handle_signature/handle_sign_shielded, committer.rs authenticate_message, or sentinel/processing.rs handle_process_request change"
