...
This document defines all valid edge types within the knowledge graph vault. Edges represent directed relationships between two nodes via their `id` fields.
