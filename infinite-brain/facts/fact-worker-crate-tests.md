...
summary: "Verified per-crate: executor 10 passed, finalizer 66, committer 71 lib + 9 integration, sentinel 67 + 2 ignored (live halo2 e2e + doc), node-server 31 — 0 failed in every crate."
auto_inject: false
...
edges:
  - target: fact-test-suite
    type: derived_from
    weight: 0.9
    note: "Per-crate breakdown matching the workspace baseline (committer 80 = 71+9, sentinel 67, executor 10, finalizer 66, node-server 31)"
...
| pneumatic_finalizer | 66 passed (lib) |
| pneumatic_committer | 71 passed (lib) + 9 passed (`tests/pipeline_integration.rs`) = 80 |
| pneumatic_sentinel | 67 passed + 1 ignored (lib) + 1 ignored (doc-tests) |
| pneumatic_node_server | 31 passed (lib) |
